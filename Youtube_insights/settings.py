...
ROOT_URLCONF = 'Youtube_insights.urls'
...
WSGI_APPLICATION = 'Youtube_insights.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'YouTube Insights API',
    'DESCRIPTION': 'MVP for finding high-performing videos on low-sub channels.',
    'VERSION': '1.0.0',
}
